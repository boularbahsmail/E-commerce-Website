...
import produtcs from '@/data/FeaturedFashions';
import { Icon } from '../Shared/Icon';
import { FeaturedFashions } from '@/types/FeaturedFashions.types';

const FeaturedFashions = () => {
    return (
                ...
                {produtcs?.map((Fashion: FeaturedFashions) => (
                    <div
                        ...
                        <div className='min-h-[450px] bg-gray-100 w-full' style={{
                            backgroundImage: `url('${Fashion?.cover}')`,
                            ...
                            <div className='absolute right-0 bottom-0 p-4 h-max w-full bg-gradient-to-t from-black/70 via-black/70 to-transparent flex flex-col justify-center items-start gap-2'>
                                <p className='text-left text-sm text-white'>{Fashion?.description}</p>
...
export default FeaturedFashions;